...
//        intent.putExtra("geofence",reminder)
    ...
    override fun onCreateView(
        ...
        Toast.makeText(requireContext(),"Please enter reminder data!",Toast.LENGTH_SHORT).show()
            ...
            Snackbar.make(
                ...
                .setAction(R.string.settings) {
                    startActivity(Intent().apply {
                        ...
                        data = Uri.fromParts("package", "com.udacity.project4", null)
            ...
            addOnCompleteListener {
                geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent)?.run {
                    addOnSuccessListener {
                        ...
                        _viewModel.validateAndSaveReminder(reminder)
                        //todo: move to reminder list fragment
                        _viewModel.navigationCommand.value =
